...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-dqpLoYM6.mjs");
...
const manifest = {
  "22187acff0948f08134436b7a7987b3d033f0a4c627c39df38be211a6570cabf": {
    ...
    importer: () => import("./survey--_lo4fLi.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CjEqjJIw.mjs").then((n) => n.r),
    import("./start-BKBp2rIX.mjs"),
