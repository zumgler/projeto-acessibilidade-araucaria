...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CZYZ-MsQ.mjs");
...
const manifest = {
  "22187acff0948f08134436b7a7987b3d033f0a4c627c39df38be211a6570cabf": {
    functionName: "fetchSurveyStats_createServerFn_handler",
    importer: () => import("./survey-uaMTA_Nu.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-NZTXTcwR.mjs").then((n) => n.r),
    import("./start-CwvB2-j_.mjs"),
